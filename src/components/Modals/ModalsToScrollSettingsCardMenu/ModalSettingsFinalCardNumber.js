...
export default function ModalSettingsFinalCardNumber(props) {
  return (
            ...
            <View style={styles.inclusionOfDataContainer}>
              ...
              <View style={styles.inputContainer}>
                <TextInput style={styles.input}
                  ...
                  onChangeText={text => props.setFinalNumber(text)} />
              </View>
              <Text style={[styles.text, { fontSize: 15, top: 5 }]}>
                Para você adicionar ou alterar o número final do seu card,
                basta preencher no campo acima!
              </Text>
