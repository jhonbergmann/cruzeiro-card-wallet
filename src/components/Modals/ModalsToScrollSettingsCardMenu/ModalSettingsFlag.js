...
import IconVisaFlag from 'react-native-vector-icons/FontAwesome'
import IconMasterFlag from 'react-native-vector-icons/FontAwesome'

export default function ModalSettingsFlag(props) {
  return (
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <View style={styles.inclusionOfDataContainer}>
              ...
              <View style={styles.iconFlagsContainer}>
                <TouchableOpacity style={{ margin: 10 }}
                  onPress={props.onClickChangeVisaFlag}>
                  <IconVisaFlag
                    name='cc-visa'
                    size={50}
                    color='#F2F3F5'
                ...
                <TouchableOpacity style={{ margin: 10 }}
                  onPress={props.onClickChangeMasterFlag}>
                  <IconMasterFlag
                    name='cc-mastercard'
                    size={50}
                    color='#F2F3F5'
              ...
              <Text style={[styles.text, { fontSize: 15, top: 5 }]}>
                Para você adicionar ou alterar a bandeira do seu card,
                basta selecionar a bandeira acima!
              </Text>
