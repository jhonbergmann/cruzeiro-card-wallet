...
export default function ModalSettingsBankName(props) {
  return (
            ...
            <View style={styles.inclusionOfDataContainer}>
              ...
              <View style={styles.inputContainer}>
                <TextInput style={styles.input}
                  ...
                  onChangeText={text => props.setBankName(text)} />
              </View>
              <Text style={[styles.text, { fontSize: 15, top: 5 }]}>
                Para adicionar ou alterar o nome da entidade bancaria,
                basta você preencher no campo acima!
              </Text>
