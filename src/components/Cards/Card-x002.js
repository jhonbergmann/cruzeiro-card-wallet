...
export default function Card02() {
  ...
  const savePayDayData = async () => {
    try {
      await AsyncStorage.setItem("@keyPayDay-x002", payDay)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadPayDayData = async () => {
    try {
      let payDay = await AsyncStorage.getItem("@keyPayDay-x002")
  ...
  const saveFlagData = async () => {
    try {
      await AsyncStorage.setItem("@keyFlag-x002", JSON.stringify(flag))
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadFlagData = async () => {
    try {
      let flag = await AsyncStorage.getItem("@keyFlag-x002")
  ...
  const saveBestDayData = async () => {
    try {
      await AsyncStorage.setItem("@keyBestDay-x002", bestDay)
    } catch (err) {
      Alert.alert(
        'Ops!',
        'Você esqueceu de preencher algum dado!'
  ...
  const loadBestDayData = async () => {
    try {
      let bestDay = await AsyncStorage.getItem("@keyBestDay-x002")
  ...
  const saveFinalCardNumberData = async () => {
    try {
      await AsyncStorage.setItem("@keyFinalCardNumber-x002", finalCardNumber)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadFinalCardNumberData = async () => {
    try {
      let finalCardNumber = await AsyncStorage.getItem("@keyFinalCardNumber-x002")
  ...
  const saveBankNameData = async () => {
    try {
      await AsyncStorage.setItem("@keybankName-x002", bankName)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadBankNameData = async () => {
    try {
      let bankName = await AsyncStorage.getItem("@keybankName-x002")
  ...
  const saveKeyData = async () => {
    try {
      await AsyncStorage.setItem("@keyKeyCard-x002", key)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadKeyData = async () => {
    try {
      let key = await AsyncStorage.getItem("@keyKeyCard-x002")
  ...
  const saveBackgroundColor = async () => {
    try {
      await AsyncStorage.setItem("@keyBackgroundColor-x002", changeBackgroundColor)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadBackgroundColor = async () => {
    try {
      let changeBackgroundColor = await AsyncStorage.getItem("@keyBackgroundColor-x002")
