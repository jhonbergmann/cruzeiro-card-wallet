...
export default function Card03() {
  ...
  const savePayDayData = async () => {
    try {
      await AsyncStorage.setItem("@keyPayDay-x003", payDay)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadPayDayData = async () => {
    try {
      let payDay = await AsyncStorage.getItem("@keyPayDay-x003")
  ...
  const saveFlagData = async () => {
    try {
      await AsyncStorage.setItem("@keyFlag-x003", JSON.stringify(flag))
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadFlagData = async () => {
    try {
      let flag = await AsyncStorage.getItem("@keyFlag-x003")
  ...
  const saveBestDayData = async () => {
    try {
      await AsyncStorage.setItem("@keyBestDay-x003", bestDay)
    } catch (err) {
      Alert.alert(
        'Ops!',
        'Você esqueceu de preencher algum dado!'
  ...
  const loadBestDayData = async () => {
    try {
      let bestDay = await AsyncStorage.getItem("@keyBestDay-x003")
  ...
  const saveFinalCardNumberData = async () => {
    try {
      await AsyncStorage.setItem("@keyFinalCardNumber-x003", finalCardNumber)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadFinalCardNumberData = async () => {
    try {
      let finalCardNumber = await AsyncStorage.getItem("@keyFinalCardNumber-x003")
  ...
  const saveBankNameData = async () => {
    try {
      await AsyncStorage.setItem("@keybankName-x003", bankName)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadBankNameData = async () => {
    try {
      let bankName = await AsyncStorage.getItem("@keybankName-x003")
  ...
  const saveKeyData = async () => {
    try {
      await AsyncStorage.setItem("@keyKeyCard-x003", key)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadKeyData = async () => {
    try {
      let key = await AsyncStorage.getItem("@keyKeyCard-x003")
  ...
  const saveBackgroundColor = async () => {
    try {
      await AsyncStorage.setItem("@keyBackgroundColor-x003", changeBackgroundColor)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadBackgroundColor = async () => {
    try {
      let changeBackgroundColor = await AsyncStorage.getItem("@keyBackgroundColor-x003")
