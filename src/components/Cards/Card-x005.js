...
export default function Card05() {
  ...
  const savePayDayData = async () => {
    try {
      await AsyncStorage.setItem("@keyPayDay-x005", payDay)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadPayDayData = async () => {
    try {
      let payDay = await AsyncStorage.getItem("@keyPayDay-x005")
  ...
  const saveFlagData = async () => {
    try {
      await AsyncStorage.setItem("@keyFlag-x005", JSON.stringify(flag))
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadFlagData = async () => {
    try {
      let flag = await AsyncStorage.getItem("@keyFlag-x005")
  ...
  const saveBestDayData = async () => {
    try {
      await AsyncStorage.setItem("@keyBestDay-x005", bestDay)
    } catch (err) {
      Alert.alert(
        'Ops!',
        'Você esqueceu de preencher algum dado!'
  ...
  const loadBestDayData = async () => {
    try {
      let bestDay = await AsyncStorage.getItem("@keyBestDay-x005")
  ...
  const saveFinalCardNumberData = async () => {
    try {
      await AsyncStorage.setItem("@keyFinalCardNumber-x005", finalCardNumber)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadFinalCardNumberData = async () => {
    try {
      let finalCardNumber = await AsyncStorage.getItem("@keyFinalCardNumber-x005")
  ...
  const saveBankNameData = async () => {
    try {
      await AsyncStorage.setItem("@keybankName-x005", bankName)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadBankNameData = async () => {
    try {
      let bankName = await AsyncStorage.getItem("@keybankName-x005")
  ...
  const saveKeyData = async () => {
    try {
      await AsyncStorage.setItem("@keyKeyCard-x005", key)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadKeyData = async () => {
    try {
      let key = await AsyncStorage.getItem("@keyKeyCard-x005")
  ...
  const saveBackgroundColor = async () => {
    try {
      await AsyncStorage.setItem("@keyBackgroundColor-x005", changeBackgroundColor)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadBackgroundColor = async () => {
    try {
      let changeBackgroundColor = await AsyncStorage.getItem("@keyBackgroundColor-x005")
