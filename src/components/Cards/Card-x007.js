...
export default function Card07() {
  ...
  const savePayDayData = async () => {
    try {
      await AsyncStorage.setItem("@keyPayDay-x007", payDay)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadPayDayData = async () => {
    try {
      let payDay = await AsyncStorage.getItem("@keyPayDay-x007")
  ...
  const saveFlagData = async () => {
    try {
      await AsyncStorage.setItem("@keyFlag-x007", JSON.stringify(flag))
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadFlagData = async () => {
    try {
      let flag = await AsyncStorage.getItem("@keyFlag-x007")
  ...
  const saveBestDayData = async () => {
    try {
      await AsyncStorage.setItem("@keyBestDay-x007", bestDay)
    } catch (err) {
      Alert.alert(
        'Ops!',
        'Você esqueceu de preencher algum dado!'
  ...
  const loadBestDayData = async () => {
    try {
      let bestDay = await AsyncStorage.getItem("@keyBestDay-x007")
  ...
  const saveFinalCardNumberData = async () => {
    try {
      await AsyncStorage.setItem("@keyFinalCardNumber-x007", finalCardNumber)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadFinalCardNumberData = async () => {
    try {
      let finalCardNumber = await AsyncStorage.getItem("@keyFinalCardNumber-x007")
  ...
  const saveBankNameData = async () => {
    try {
      await AsyncStorage.setItem("@keybankName-x007", bankName)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadBankNameData = async () => {
    try {
      let bankName = await AsyncStorage.getItem("@keybankName-x007")
  ...
  const saveKeyData = async () => {
    try {
      await AsyncStorage.setItem("@keyKeyCard-x007", key)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadKeyData = async () => {
    try {
      let key = await AsyncStorage.getItem("@keyKeyCard-x007")
  ...
  const saveBackgroundColor = async () => {
    try {
      await AsyncStorage.setItem("@keyBackgroundColor-x007", changeBackgroundColor)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadBackgroundColor = async () => {
    try {
      let changeBackgroundColor = await AsyncStorage.getItem("@keyBackgroundColor-x007")
