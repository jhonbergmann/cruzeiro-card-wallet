...
export default function Card10() {
  ...
  const savePayDayData = async () => {
    try {
      await AsyncStorage.setItem("@keyPayDay-x0010", payDay)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadPayDayData = async () => {
    try {
      let payDay = await AsyncStorage.getItem("@keyPayDay-x0010")
  ...
  const saveFlagData = async () => {
    try {
      await AsyncStorage.setItem("@keyFlag-x0010", JSON.stringify(flag))
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadFlagData = async () => {
    try {
      let flag = await AsyncStorage.getItem("@keyFlag-x0010")
  ...
  const saveBestDayData = async () => {
    try {
      await AsyncStorage.setItem("@keyBestDay-x0010", bestDay)
    } catch (err) {
      Alert.alert(
        'Ops!',
        'Você esqueceu de preencher algum dado!'
  ...
  const loadBestDayData = async () => {
    try {
      let bestDay = await AsyncStorage.getItem("@keyBestDay-x0010")
  ...
  const saveFinalCardNumberData = async () => {
    try {
      await AsyncStorage.setItem("@keyFinalCardNumber-x0010", finalCardNumber)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadFinalCardNumberData = async () => {
    try {
      let finalCardNumber = await AsyncStorage.getItem("@keyFinalCardNumber-x0010")
  ...
  const saveBankNameData = async () => {
    try {
      await AsyncStorage.setItem("@keybankName-x0010", bankName)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadBankNameData = async () => {
    try {
      let bankName = await AsyncStorage.getItem("@keybankName-x0010")
  ...
  const saveKeyData = async () => {
    try {
      await AsyncStorage.setItem("@keyKeyCard-x0010", key)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadKeyData = async () => {
    try {
      let key = await AsyncStorage.getItem("@keyKeyCard-x0010")
  ...
  const saveBackgroundColor = async () => {
    try {
      await AsyncStorage.setItem("@keyBackgroundColor-x0010", changeBackgroundColor)
    } catch (err) {
      Alert.alert(
        'Ops!',
  ...
  const loadBackgroundColor = async () => {
    try {
      let changeBackgroundColor = await AsyncStorage.getItem("@keyBackgroundColor-x0010")
